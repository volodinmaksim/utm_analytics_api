...
from analytics_app.app.models import CbtbaseUser, FarmaUser, PsygastroUser, ServiceType, SfbtUser, User
...
SERVICE_MATCHING_CONFIG = {
    ...
    ServiceType.PSYGASTRO: (PsygastroUser, "psygastro_user_id"),
}
